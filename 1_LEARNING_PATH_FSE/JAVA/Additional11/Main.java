	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				Stream<Participant> s=viewObj.viewAllParticipants(departmentName,collegeName);
				s.forEach(p -> 
				   System.out.println(p.getParticipantName()+" "+p.getDepartmentName()+" "+p.getCollegeName()));
				break;
			case 3:
